...
//		HCNetSDK.getInstance().NET_DVR_SetSimAbilityPath(path, strSDCard);
	...
	public static void Test_PresetName(int iUserID, int iChan)
	{
		...
		{
			Log.e("blw","Test_PresetName:"+HCNetSDK.getInstance().NET_DVR_GetLastError());
			System.out.println("NET_DVR_GET_PRESET_NAME faild!" + " err: " + HCNetSDK.getInstance().NET_DVR_GetLastError());
		}
		else
		{ Log.e("blw","Test_PresetName:"+struPresetNameArray.struPresetName);
			System.out.println("blw   NET_DVR_GET_PRESET_NAME succ! "+struPresetNameArray.struPresetName);
		}
	}
	public static void Test_ShowString(int iUserID, int iChan)
	{
		...
		else
		{
			...
			;
			Log.e("blw","Test_PresetName:"+new String(struShowString.struStringInfo[0].sString)+","+new String(struShowString.struStringInfo[2].sString));
	...
	public static void Test_DigitalChannelState(int iUserID)
	{
		...
		else
		{
			...
			Log.e("blw","analog channel 1 and 2:" + (int)struChanState.byAnalogChanState[0] + "-" + (int)struChanState.byAnalogChanState[1] +
...
public static void Test_ExceptionCfg_V40(int iUserID, int iChan)
{
	...
	public static void Test_PicCfg(int iUserID, int iChan)
	{
		...
		{
			Log.e("blw ","Test_PicCfg:"+HCNetSDK.getInstance().NET_DVR_GetLastError());
			System.out.println("NET_DVR_GET_PICCFG_V30 faild!" + " err: " + HCNetSDK.getInstance().NET_DVR_GetLastError());
		}
		else
		{ Log.e("blw ","Test_PicCfg:"+new String(struPiccfg.sChanName));
