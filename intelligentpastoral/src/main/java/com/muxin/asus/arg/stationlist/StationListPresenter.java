...
public class StationListPresenter implements StationListContract.Presenter {
    ...
    private StationListContract.Model mModel;
    ...
    public StationListPresenter(StationListContract.View view) {
        mView = view;
        mContext = view.getContext();
        mModel = new StationListModel(mContext);
    ...
    public void loadData() {
        mModel.loadData(new ModelAfter() {
            ...
            public void success(Object o) {
                mView.initListView((StationResponse[]) o);
            }
